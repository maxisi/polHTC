...
detparams = { # source for LIGO: LIGO-T980044; else: http://arxiv.org/abs/gr-qc/9607075)
        'LHO': {
                'lat': 0.81079526, # N 46° 27’18.528”
                'lon': -2.084056769, # W 119° 24’27.5657”
                'x_east': 2.199, # N 35.9994° W
                'arm_ang': np.pi/2.
                },
    
        'LLO': {
                'lat': 0.533423135, # N 30° 33’46.4196”
                'lon': -1.584309371, # W 90° 46’27.2654”
                'x_east': 3.4508, # S 72.2835° W
                'arm_ang': np.pi/2.
                },
